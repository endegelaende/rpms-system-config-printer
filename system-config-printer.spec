...
# Querencia Linux: always build the applet subpackage on EL10
%package applet
...
# Querencia Linux: always ship applet files on EL10
%files applet
%{_bindir}/%{name}-applet
...
# Querencia Linux: always ship the main GUI package on EL10
%files
%doc ChangeLog NEWS ABOUT-NLS AUTHORS ChangeLog-OLD
%license COPYING
%{_bindir}/%{name}
...
- Enable full GUI build on EL10 by removing RHEL-only GUI stripping conditionals
- Always build and ship the applet subpackage on EL10
